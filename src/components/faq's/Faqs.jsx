...
const Faqs = () => {
    ...
    const faqArray = [
        ...
        },
        {
            ...
            ans: "Small and medium-sized businesses (SMBs), suppliers, distributors, manufacturers, and other entities involved in the supply chain can benefit from supply chain lending."
        },
        {
            id: "3",
