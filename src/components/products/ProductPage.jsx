            ...
            <section class="relative py-32 bg-white">
                ...
                <div class="min-w-screen min-h-screen items-center  lg:px-4 overflow-hidden relative">
                    ...
                    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 mb-14 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                        <div class="md:flex items-center -mx-10">
                            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                <img alt="..." class="w-full rounded-lg shadow-lg" src={imgUrl + '/img/others/propageVendor.avif'} />
                            </div>
                            <div class="w-full md:w-1/2 px-10">
                                ...
                                <div>
                                    <button
                                        onClick={() => history.push('/products/vendor-financing')}
                    ...
                    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 mb-14 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                        <div class="md:flex items-center -mx-10">
                            <div class="w-full md:w-1/2 px-10">
                                ...
                                <div>
                                    <button
                                        onClick={() => history.push('/products/invoice-discounting')}
                                        className="inline-flex items-center py-2 px-4 mt-4 md:mt-0 border border-transparent shadow-sm text-sm font-medium font-serif text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    >Know More
                                    </button>
                                </div>
                            ...
                            <div class="w-full md:w-1/2 px-10 my-10 md:mb-0">
                                <img alt="..." class="w-full rounded-lg shadow-lg" src={imgUrl + '/img/blogs/invoiceDiscounting.png'} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 mb-14 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                        <div class="md:flex items-center -mx-10">
                            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                <img alt="..." class="w-full rounded-lg shadow-lg" src={imgUrl + '/img/others/propageExp.avif'} />
                            </div>
                            <div class="w-full md:w-1/2 px-10">
                                <div class="mb-10">
                                ...
                                <div>
                                    <button
                                        onClick={() => history.push('/products/export-credits')}
                                        className="inline-flex items-center py-2 px-4 mt-4 md:mt-0 border border-transparent shadow-sm text-sm font-medium font-serif text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    >Know More
                                    </button>
                                </div>
                    ...
                    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 mb-14 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                        <div class="md:flex items-center -mx-10">
                            ...
                            <div class="w-full md:w-1/2 px-10 my-10 md:mb-0">
                                <img alt="..." class="w-full rounded-lg shadow-lg" src={imgUrl + '/img/others/propagecredit.png'} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 mb-14 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                        <div class="md:flex items-center -mx-10">
                            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                <img alt="..." class="w-full rounded-lg shadow-lg" src={imgUrl + '/img/others/propageEd.avif'} />
                            </div>
                            <div class="w-full md:w-1/2 px-10">
                                <div class="mb-10">
                                ...
                                <div>
                                    <button
                                        onClick={() => history.push('/products/edquery-solutions')}
                                        className="inline-flex items-center py-2 px-4 mt-4 md:mt-0 border border-transparent shadow-sm text-sm font-medium font-serif text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    >Know More
                                    </button>
                                </div>
