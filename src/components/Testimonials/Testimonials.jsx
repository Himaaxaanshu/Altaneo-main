        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-3">
          <div className='bg-white rounded-lg border slide col ' style={{ width: 320, height: 400 }}>
            <div className='user-info'>
              <img src={imgUrl + '/img/others/DeepakGoal.png'} alt='' style={{ width: 70, height: 70 }} />
              <div>
          ...
          <div className='bg-white rounded-lg border slide col' style={{ width: 320, height: 400 }}>
            <div className='user-info'>
              <img src={imgUrl + '/img/others/GouravDhmija.png'} alt='' style={{ width: 70, height: 70 }} />
              <div>
          ...
          <div className='bg-white rounded-lg border slide col' style={{ width: 320, height: 400 }}>
            <div className='user-info'>
              <img src={imgUrl + '/img/others/YogeshSingla.png'} alt='' style={{ width: 70, height: 70 }} />
              <div>
                <h3>Yogesh Singla</h3>
